...
public class Familias {
  ...
  private int id_casa_familia;
    ...
    public String toString() {
        return "Familias{" + "id_familia=" + id_familia + ", nombre=" + nombre + ", edad_minima=" + edad_minima + ", edad_maxima=" + edad_maxima + ", num_hijos=" + num_hijos + ", email=" + email + ", id_casa_familia=" + id_casa_familia + '}';
    }
}
