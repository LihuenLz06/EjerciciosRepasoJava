 ...
 */
public class Servicio extends Cine{
    Scanner sc = new Scanner(System.in);
        ...
        System.out.print("Ingrese la duraciÃ³n de la pelÃ­cula (en minutos): ");
        int duracion = sc.nextInt();

        System.out.print("Ingrese la edad mÃ­nima requerida para ver la pelÃ­cula: ");
        int edadMinima = sc.nextInt();

        System.out.print("Ingrese el nombre del director de la pelÃ­cula: ");
        sc.nextLine();
